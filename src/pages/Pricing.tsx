...
const features = [
  ...
  },
  {
    ...
    free: '✕',
    supporter: '✓',
    description: 'Browse and create pastes without advertisements'
  }
];
        ...
        <div className="mt-12 bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-primary-700/20 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              ...
              <p className="text-primary-200">Yes! You can save 17% by choosing annual billing at $50/year instead of monthly billing.</p>
            </div>
          </div>
        </div>
      </div>
